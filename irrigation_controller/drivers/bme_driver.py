# bme280_driver.py Driver para sensor BME280 compatible con MicroPython
...
class BME280:
    def __init__(self, i2c: machine.I2C, address=BME280_I2C_ADDR) -> None:
        self.i2c = i2c
    ...
    def _read_s16(self, register: int) -> int:
        return int(struct.unpack("<h", self.i2c.readfrom_mem(self.address, register, 2))[0])
    ...
    def compensate_temperature(self, adc_t: int) -> float:
    ...
    def compensate_pressure(self, adc_p: int) -> float:
    ...
    def compensate_humidity(self, adc_h: int) -> float:
